...
Feature: As an editing teacher, copying a section with a subsection, should automatically
  ...
  Scenario: A course has a section with a subsection containing an activity.
    ...
    And I wait until "//li[@id='section-1']//*[contains(@class,'add_to_sharing_cart')]" "xpath_element" exists
    And I click on "//li[@id='section-1']//*[contains(@class,'add_to_sharing_cart')]" "xpath_element"
