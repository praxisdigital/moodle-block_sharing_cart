...
Feature: As an editing teacher, I can click the sharing cart button on an activity
  ...
  Scenario: The editing teacher clicks the sharing cart basket icon on an activity
    When I click on "//li[@data-for='cmitem'][.//span[contains(@class,'instancename')][contains(text(),'Book 1')]]//*[contains(@class,'cm_action_menu')]//i[contains(@class,'add_to_sharing_cart')]" "xpath_element"
