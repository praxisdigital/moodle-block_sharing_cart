...
Feature: As an editing teacher, I can drag and drop a section onto the sharing cart block
  so that a backup of the section is queued into my sharing cart.
  ...
  Scenario: The editing teacher drags a section onto the sharing cart block
    When I drag the "Section 1" section to the sharing cart
