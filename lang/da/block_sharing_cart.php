...
$string['confirm_copy_item_form_text'] = 'Er du sikker på, at du vil kopiere denne backup?' .
    ' Nedenfor kan du vælge, hvad der skal inkluderes i kopien.';
...
$string['empty_section_restore'] = 'Noget gik galt i forsøget på at kopiere det valgte fra sharing cart.' .
    ' Det valgte emne er tomt.';
...
$string['no_items'] = 'Ingen backups.<br><br>Træk og slip aktiviteter eller sektioner ind i delingskurven eller klik' .
    ' på <i class="fa fa-shopping-basket"></i> ikonet, for at tilføje elementer til Delingskurven.';
$string['no_restores'] = '<div class="no-restores text-muted">Ingen kopieringer i kø.<br><br>Klik på <i class="fa fa-clone"></i>' .
    ' ikonet for at kopiere elementer fra Delingskurven til kurset.</div>';
