...
/**
 * Language strings for block_sharing_cart.
 *
...
$string['confirm_copy_item_form_text'] = 'Are you sure you want to copy this item? Below you can select what to include' .
    ' in the copy.';
...
$string['copy_quiz_warning'] = 'Warning! - You are about to copy a quiz into the sharing cart. This could take a while,' .
    ' if there are a lot of questions in the course.';
...
$string['no_course_modules_in_section_description'] = 'This section does not contain any course modules and you are' .
    ' therefore not able to copy it.';
$string['no_items'] = 'No items.<br><br>Drag & drop activities or sections into the sharing cart or click' .
    ' the <i class="fa fa-shopping-basket"></i> icon, to add items to the Sharing Cart.';
$string['no_restores'] = '<div class="no-restores text-muted">No copies queued.<br><br>Click the <i class="fa fa-clone"></i>' .
    ' icon to copy items from the Sharing Cart to the course.</div>';
$string['nopermissions'] = 'You do not have permission to backup or restore items in this course. Please contact your' .
...
$string['you_may_need_to_reload_the_course_warning'] = 'Element(s) inserted. You may need to reload the course page to see' .
    ' the changes reflected correctly.';
