...
class content implements \core\output\named_templatable, \renderable {
    ...
    public function export_for_template(\renderer_base $OUTPUT): array {
        ...
        return [
            ...
            'canBackupUserdata' => (int)has_capability('moodle/backup:userinfo', $coursecontext),
            'canAnonymizeUserdata' => (int)has_capability('moodle/backup:anonymise', $coursecontext),
            'canBackup' => (int)has_capability('moodle/backup:backupactivity', $coursecontext),
            'showSharingCartBasket' => (int)(bool)get_config('block_sharing_cart', 'show_sharing_cart_basket'),
            'showCopySectionInBlock' => (int)(bool)get_config('block_sharing_cart', 'show_copy_section_in_block'),
